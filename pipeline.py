...
LUA_SHA1 = get_hash(os.path.join(CWD, 'firefox-addons.lua'))
...
project = Project(
    ...
    project_html = '''
    <img class="project-logo" alt="logo" src="https://www.archiveteam.org/images/5/59/Mozilla-firefox-logo-text.png" height="50px"/>
    <h2>addons.mozilla.org <span class="links"><a href="https://addons.mozilla.org/">Website</a> &middot; <a href="http://tracker.archiveteam.org/firefox-addons/">Leaderboard</a></span></h2>
    '''
)
...
pipeline = Pipeline(
    ...
    GetItemFromTracker('http://%s/%s' % (TRACKER_HOST, TRACKER_ID), downloader,
        VERSION),
    PrepareDirectories(warc_prefix='firefox-addons'),
    WgetDownload(
        WgetArgs(),
        max_tries=2,
